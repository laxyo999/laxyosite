@extends('layouts.app') @section('title', 'Railway Contractors, Track Laying & Linking, Private Railway Siding Maintenance &amp; Railway Construction') @section('meta')
...
<meta name="keywords" content="private railway siding maintenance company, railway construction company, railway track laying, railway contractors, railway signaling contractors, railway track linking, laying and linking, railway contractors India, railway signaling, private siding railway signalling, railway track S & T Contractors, signaling contractors, railway signaling. " />@endsection @section('body')
<!--Start TITLE PAGE-->
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="item"><img src="img/railway/track-maintenance.jpg"></div>-->
          <div class="item">
            <img src="{{asset('img/railway/railway-contractors-01.jpg')}}" alt="railway contractors" width="100%">
          </div>
          <div class="item">
            <img src="{{asset('img/railway/railway-contractors-02.jpg')}}" alt="railway contractors"  width="100%">
          </div>
          <div class="item">
            <img src="{{asset('img/railway/railway-contractors-03.jpg')}}" alt="railway contractors"  width="100%">
          </div>
          <div class="item">
            <img src="{{asset('img/railway/railway-contractors-04.jpg')}}" alt="railway contractors"  width="100%">
          </div>
          <div class="item">
            <img src="{{asset('img/railway/railway-contractors-05.jpg')}}" alt="railway contractors"  width="100%">
          </div>
          <div class="item">
            <img src="{{asset('img/railway/railway-contractors-06.jpg')}}" alt="railway contractors"  width="100%">
          </div>
        </div>
        ...
        <section>
          <div class="row">
            ...
            <div class="infrastructure"> <strong>32 kms of Railway Track laid in 40 Days in the rough working environment</strong> 
              <blockquote class="default">
